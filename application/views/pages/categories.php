          ...
          if(affectedItems <= 0){
            <?php
              if($accountTypeSession == 'Administrator' || $accountTypeSession == 'Super-Administrator'){
                echo "msg = 'WARNING: This operation is irreversible, once deleted category can\'t be restored again.\\n\\nContinue deleting this category?';";
              } else{
                echo "msg = 'Are you sure you want to remove this category?';";
              }
            ?>
            if(confirm(msg)){
              $.ajax({
      ...
      $.ajax({
        ...
        success:function(affectedItems){
          if(affectedItems <= 0){
            <?php
              if($accountTypeSession == 'Administrator' || $accountTypeSession == 'Super-Administrator'){
                echo "msg = 'WARNING: This operation is irreversible, once deleted category/s can\'t be restored again.\\n\\nContinue deleting selected category/s?';";
              } else{
                echo "msg = 'Are you sure you want to remove selected category/s?';";
              }
            ?>
            if(confirm(msg)){
              $.ajax({
